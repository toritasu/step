...
<main class="l-main">
  ...
  <div class="l-narrow -center">
    <h2 class="c-subtitle">@yield('heading', 'STEPを投稿する')</h2>
      ...
      <div>
        <ul>
          @foreach($errors->all() as $message)
            <li class="c-errorMessage">{{ $message }}</li>
          @endforeach
        </ul>
      </div>
    @endif
    ...
    <form class="c-inputField" method="post" enctype="multipart/form-data">
      ...
      <section class="c-inputField__form">
        ...
        <label class="c-inputField__form__checklabel"
          ...
          <input type="checkbox" class="c-inputField__form__checkbox"
                ...
                @{{category.label}}
          <input type="hidden" name="imageDefault" v-bind:value="postedData.image">
        </label>
      </section>
      ...
      <section class="c-inputField__form">
        ...
        <textarea name="description"
                  class="c-inputField__form__textbox"
      ...
      <section class="c-inputField__form">
        ...
        <label class="c-inputField__form__preview">
          <img class="filePreview c-inputField__form__preview__picture" alt="イメージ画像"
              v-bind:src="selectedImage|prefixed">
          ...
          <table class="c-table">
            ...
            <tr class="c-table__row">
              ...
              <td class="c-table__cell -content">
                <img class="filePreview" style="width: 100%" :src="postedData.image|prefixed" alt="イメージ画像">
              </td>
            </tr>
