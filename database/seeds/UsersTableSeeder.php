...
class UsersTableSeeder extends Seeder
{
    ...
    {
      $users = [
          [ 'name' => 'かずきち', 'email' => 'kazukichi@webukatu', 'intro' => 'オラオラオラ！', 'avater' => 'storage/images/avaters/user_1.jpg'],
          ...
          [ 'name' => '山寺宏一', 'email' => 'yamachan@webukatu', 'intro' => '声優の山寺です。', 'avater' => 'storage/images/avaters/user_5.jpg'],
      ];
